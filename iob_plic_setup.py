...
[
    ...
    # PLIC Parameters
    {'name':'SOURCES', 'type':'P', 'val':'64',  'min':'NA', 'max':'64',  'descr':"Number of interrupt sources"},
    {'name':'TARGETS', 'type':'P', 'val':'4',  'min':'NA', 'max':'8',  'descr':"Number of interrupt targets"},
...
[
    ...
    {'name': 'plic_io', 'descr':'PLIC specific IO.', 'ports': [
        ...
        {'name':'src', 'type':'I', 'n_bits':'SOURCES', 'descr':'Interrupt sources'},
        {'name':'irq', 'type':'O', 'n_bits':'TARGETS', 'descr':'Interrupt Requests'},
    ]}
]
