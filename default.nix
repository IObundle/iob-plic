...
let
  py2hwsw_commit = "d1e3a900bd191350c7396f99a02d54badb35ef74"; # Replace with the desired commit.
  py2hwsw_sha256 = "qqKPbAfcX5KsSkPXKy2lZzwGaZFqxqxU+ddEedK+CQA="; # Replace with the actual SHA256 hash.
